...
jQuery(document).ready(function(){
	...
	"use strict";
	console.log('Document is ready');  // Add this line for debugging
...
function shane_tm_contact_form(){
    ...
    jQuery(".contact_form #send_message").off().on('click', function(){
		console.log("Send Message clicked!");  // This line will print to the console
        ...
        if(name===''||email===''||message===''){
            ...
            handleContactForm(name, email, message, subject, success);
        }
